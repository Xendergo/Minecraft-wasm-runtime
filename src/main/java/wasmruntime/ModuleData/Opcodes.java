...
import wasmruntime.Operations.Conversions.Convert;
...
public class Opcodes {
  ...
  static {
    ...
    opcodeMap.put((byte) 0xb2, new InstructionType(Convert::f32_i32_s, i32Tof32, new WasmType[0]));
    opcodeMap.put((byte) 0xb3, new InstructionType(Convert::f32_i32_u, i32Tof32, new WasmType[0]));
    opcodeMap.put((byte) 0xb4, new InstructionType(Convert::f32_i64_s, i64Tof32, new WasmType[0]));
    opcodeMap.put((byte) 0xb5, new InstructionType(Convert::f32_i64_u, i64Tof32, new WasmType[0]));
    opcodeMap.put((byte) 0xb6, new InstructionType(PromoteDemote::demote, f64Tof32, new WasmType[0]));
    opcodeMap.put((byte) 0xb7, new InstructionType(Convert::f64_i32_s, i32Tof64, new WasmType[0]));
    opcodeMap.put((byte) 0xb8, new InstructionType(Convert::f64_i32_u, i32Tof64, new WasmType[0]));
